...
export default {
  ...
  permissions: {
    ...
    locationBannerClient:
      'Turn on GPS / location services and allow access for accurate job posting.',
  ...
  jobs: {
    ...
    completeAssigned: 'Complete Assigned',
    jobFirst: 'Job First',
    pickupJob: 'Pickup Job',
    deliveryFromHeading: 'From',
    deliveryToHeading: 'To',
    ...
    workCooldownShort: '6h wait',
    workCooldownBlocked:
      'You cannot pick up jobs, apply, or make offers during the 6-hour period after unassigning via Support.',
  ...
  rating: {
    ...
    oneStarTitle: 'Tell us what went wrong',
  },
  verification: {
  ...
  settings: {
    ...
    selectPreferenceDesc: "You'll be notified for every new jobs of your preference.",
    preferenceSaved: 'Job preference saved',
    preferenceCleared: 'Job preference cleared',
    chooseCategoryPreference: 'Choose job category',
  ...
  postJob: {
    ...
    category: 'Category',
    selectCategoryToContinue: 'Choose the job you want to get done.',
    searchOther: 'Search',
    change: 'Change',
    ...
    categoryOther: 'Other',
    categorySubTwoWheeler: 'Two Wheeler',
    categorySubThreeWheeler: 'Three Wheeler',
    categorySubFourWheeler: 'Four Wheeler',
    categorySubHeavyCommercialTrucks: 'Heavy Commercial Trucks',
    categorySubBike: 'Bike',
    categorySubCar: 'Car',
    categorySubTrucks: 'Trucks',
    categorySubMechanicThreeWheeler: 'Three Wheeler',
    selectDeliveryType: 'Choose delivery type',
    selectMechanicType: 'Choose vehicle type',
    address: 'Address',
  ...
  supportBot: {
    ...
    orders: {
      ...
      cancelConfirmBody:
        'If you unassign the job, you will not be able to apply or make offer to any job for the next 6 hours.',

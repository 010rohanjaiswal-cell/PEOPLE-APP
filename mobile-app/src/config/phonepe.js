 ...
 * @param {string} params.checkSum - Checksum generated by backend (REQUIRED)
...
export const startPhonePeTransaction = async (params) => {
  try {
    ...
    if (!checkSum) {
      throw new Error('Checksum is required for PhonePe SDK transaction. It should be generated by the backend.');
    }
    ...
    try {
      ...
      // 
      // checkSum is generated by backend using SHA256(request body + salt key)
      // where salt key is the clientSecret
